...
public class RoleServiceImpl implements IRoleService {
    ...
    public Page<RoleResponse> searchRoles(RoleFilter roleFilter) {
        log.debug("Searching roles with filter: search='{}', status={}, page={}, size={}, sortBy={}, orderBy={}",
        ...
        Page<Role> roles = roleRepository.searchRoles(normalizedSearch, isDelete, pageable);
