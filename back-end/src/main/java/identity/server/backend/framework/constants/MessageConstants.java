package identity.server.backend.framework.constants;
...
public class MessageConstants {
    ...
    public static final String DELETE_ROLE_SUCCESS = "Role delete successfully.";
    ...
    public static final String USER_REACTIVATED_SUCCESS = "User reactivated successfully.";
